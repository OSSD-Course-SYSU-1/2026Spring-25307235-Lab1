...
export class Led extends ViewV2 {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda, extraInfo) {
        ...
        this.settings = new Settings('', 88, FontWeight.Regular, 8, false, '#FFFFFF');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.fontColor(this.settings.fontColor);
                    Text.scale({ x: this.settings.isMirror ? -1 : 1 });
                }, Text);
                Text.pop();
                Column.pop();
            ...
            NavDestination.backgroundColor(this.settings.isNightMode ? '#000000' : undefined);
            NavDestination.linearGradient(this.settings.isNightMode ? undefined : {
...
export function LedBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new Led(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Led.ets", line: 73, col: 3 });
